...
>You can download an old build of the game [here](http://download.noslimes.com/Games/NoSlimes/HaraldSetup.exe) and try it yourself if you want to!  
[Here's](http://download.noslimes.com/Games/NoSlimes/Harald.zip) a zipped folder instead of an installer.
{: .prompt-info }
